...
public class BotNumberTwo implements ISlackBot {
	...
	public String randomAdjective() {
		String[] adjectives = { "other", "new", "good", "high", "old", "great", "big", "American", "small", "large",
				"national", "young", "different", "black", "long", "little", "important", "political", "bad", "white",
				"real", "best", "right", "social", "only", "public", "sure", "low", "early", "able", "late", "hard",
				"major", "better", "strong", "international", "full", "special", "easy", "recent", "personal", "open",
				"red", "difficult", "available", "short", "single", "medical", "current", "wrong", "private", "past",
				"fine", "common", "poor", "natural", "significant", "hot", "happy", "serious", "ready", "simple",
				"general", "environmental", "financial", "blue", "dark", "various", "entire", "close", "cold", "final",
	...
	public String randomNegative() {
		String[] availableMessages = { ":(", "sigh", "nope" };
		return availableMessages[utility.randomNumber(availableMessages)];
	}
	...
	public String randomPositve() {
		String[] availableMessages = { "Nice post", "Good stuff", "Boom" };
		return availableMessages[utility.randomNumber(availableMessages)];
	}
