...
public class TaylorBot implements ISlackBot{
    ...
    public String randomMessage(){
    	...
    	return availableMessages[randomNumber(availableMessages)];
    }
    
    private int randomNumber(String[] array){
    ...
    public String randomAdjective(){
    	...
    	return adjectives[randomNumber(adjectives)];
    }
    ...
    public String randomImage(){
    	...
    	return availableImage[randomNumber(availableImage)];
    }
	...
	public void botResponses(String[] messages) throws IOException{
		...
		else if(messages[1].toLowerCase().contains("kayne") && !messages[0].equals(SlackInfo.getLastMessage())){
			SlackInfo.setLastMessage(messages[0]);
